...
def setup(args):
	...
	for prompt in prompt_pairs:
		_, dataset_prompts, _ = model_diff.create_response_prompt_and_format(
			args, args.data_name, prompt
		)
		dataset_prompts_pair.append(dataset_prompts)
	model_diff.generate_svd_diff_layerwise(args, dataset_prompts_pair, args.hs_diff_save_path)
