...
def setup(args):
	...
	model_diff.apply_weight_diff(args, reasoning_vector, transfer=True, alpha_h=args.alpha_h)
...
def create_filename(args, data_name):
	...
	out_file_prefix += "weight_&_hidden_state_"
	out_file_prefix += f"w_alpha_{args.alpha_w}_h_alpha_{args.alpha_h}_"
