#!/bin/bash
#
#SBATCH --job-name=OOD_pca_falcon
#SBATCH --account=llms-lab
#SBATCH --output=logs/OOD_pca_falcon_%j.out
#SBATCH --error=logs/OOD_pca_falcon_%j.out
...
NUM_TRAIN_SAMPLE=512


OUTPUT_ROOT="/projects/llms-lab/transfer_compare/hs_svd_arch_transfer_post_training_OOD_grid_search_pca/num_train_samples_${NUM_TRAIN_SAMPLE}"
# OUTPUT_ROOT="/projects/llms-lab/transfer_compare/hs_svd_arch_test_transfer_post_training_OOD_pca/num_train_samples_${NUM_TRAIN_SAMPLE}"
