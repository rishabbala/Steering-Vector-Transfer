#!/bin/bash
#
#SBATCH --job-name=ID_pca_falcon
#SBATCH --account=llms-lab
#SBATCH --output=logs/ID_pca_falcon_%j.out
#SBATCH --error=logs/ID_pca_falcon_%j.out
...
# OUTPUT_ROOT="/projects/llms-lab/transfer_compare/hs_svd_arch_transfer_post_training_ID_pca_grid_search/num_train_samples_${NUM_TRAIN_SAMPLE}"
OUTPUT_ROOT="/projects/llms-lab/transfer_compare/hs_svd_arch_test_transfer_post_training_ID_pca/num_train_samples_${NUM_TRAIN_SAMPLE}"
