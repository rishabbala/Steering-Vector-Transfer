...
NUM_TRAIN_SAMPLE=256

OUTPUT_ROOT="/projects/llms-lab/transfer_compare/hs_svd_arch_transfer_test_cot_avg_model_fam/num_train_samples_${NUM_TRAIN_SAMPLE}"
