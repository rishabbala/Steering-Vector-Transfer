#!/bin/bash
#
#SBATCH --job-name=OOD_pca_tc
#SBATCH --account=llms-lab
#SBATCH --output=logs/OOD_pca_tc_%j.out
#SBATCH --error=logs/OOD_pca_tc_%j.out
...
OUTPUT_ROOT="/projects/llms-lab/transfer_compare/hs_svd_arch_transfer_post_training_OOD_pca_grid_search/num_train_samples_${NUM_TRAIN_SAMPLE}"
