#!/bin/bash
#
#SBATCH --job-name=CoT_pca_falcon
#SBATCH --account=llms-lab
#SBATCH --output=logs/CoT_pca_falcon_%j.out
#SBATCH --error=logs/CoT_pca_falcon_%j.out
...
OUTPUT_ROOT="/projects/llms-lab/transfer_compare/hs_svd_arch_transfer_cot_pca_icl_cot,cot+icl/num_train_samples_${NUM_TRAIN_SAMPLE}"
# OUTPUT_ROOT="/projects/llms-lab/transfer_compare/hs_svd_arch_test_transfer_cot_pca_icl_cot,cot+icl/num_train_samples_${NUM_TRAIN_SAMPLE}"
